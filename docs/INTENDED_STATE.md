...
The canonical data file must contain, for Gothenburg 2026, the complete fee inventory below.

2.1 Port of Gothenburg (port authority)
...
2.2 Sjöfartsverket (national authority)
